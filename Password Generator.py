...
punctuationSign1= chr(random.randint(32,152)) #Generate a random lowercase letter (based on ASCII code)
punctuationSign2= chr(random.randint(32,152)) #Generate a random lowercase letter (based on ASCII code)
